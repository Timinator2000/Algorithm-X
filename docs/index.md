...
<svg class="algorithm-banner" width="100%" viewBox="0 0 1000 720"
  ...
  <style>
    ...
    .algorithm-banner .letter { fill: #555; } /* light mode default */
    @media (prefers-color-scheme: dark) {
      .algorithm-banner .letter { fill: #eee; } /* dark mode default */
    }
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Neon wave for ALGORITHM X boxes left-to-right after letters reveal
  setTimeout(() => {
