...
<svg class="algorithm-banner" width="100%" viewBox="0 0 1000 720"
  ...
  <style>
    ...
    /* Highlight for Algorithm X boxes AFTER the animation */
    .algorithm-banner .algox-highlight {
      fill: var(--algox-color);
    }
  ...
  <!-- ========================
       ALGORITHM X  (bottom layer)
       ======================== -->
  <g id="algorithm-x">
    <path class="cell algo-cell" d="M62 220h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12H62a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="78" y="248">A</text>
    <path class="cell algo-cell" d="M122 220h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12H122a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="138" y="248">L</text>
    <path class="cell algo-cell" d="M182 220h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12H182a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="198" y="248">G</text>
    <path class="cell algo-cell" d="M242 220h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12H242a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="258" y="248">O</text>
    <path class="cell algo-cell" d="M302 220h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12H302a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="318" y="248">R</text>
    <path class="cell algo-cell" d="M362 220h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12H362a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="378" y="248">I</text>
    <path class="cell algo-cell" d="M422 220h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12H422a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="438" y="248">T</text>
    <path class="cell algo-cell" d="M482 220h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12H482a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="498" y="248">H</text>
    <path class="cell algo-cell" d="M542 220h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12H542a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="558" y="248">M</text>
    <path class="cell algo-cell" d="M602 220h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12H602a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <!-- space -->
    <path class="cell algo-cell" d="M662 220h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12H662a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
  ...
  <!-- ========================
       ...
       ======================== -->
  <g id="knuth">
    <path class="cell" d="M422 40h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="438" y="68">K</text>
    <path class="cell" d="M422 100h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="438" y="128">N</text>
    <path class="cell" d="M422 160h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="438" y="188">U</text>
    <path class="cell" d="M422 280h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
  ...
  <!-- ========================
      ...
      ======================== -->
  <g id="timinator">
    <path class="cell" d="M542 100h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="558" y="128">T</text>

    <path class="cell" d="M542 160h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="558" y="188">I</text>

    <path class="cell" d="M542 280h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="558" y="308">I</text>

    <path class="cell" d="M542 340h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="558" y="368">N</text>

    <path class="cell" d="M542 400h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="558" y="428">A</text>

    <path class="cell" d="M542 460h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="558" y="488">T</text>

    <path class="cell" d="M542 520h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="558" y="548">O</text>

    <path class="cell" d="M542 580h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
  ...
  <!-- ========================
       ...
       ======================== -->
  <g id="exact">
    <path class="cell" d="M662 160h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="678" y="188">E</text>
    <path class="cell" d="M662 280h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="678" y="308">A</text>
    <path class="cell" d="M662 340h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="678" y="368">C</text>
    <path class="cell" d="M662 400h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
  ...
  <!-- ========================
       ...
       ======================== -->
  <g id="cover">
    <path class="cell" d="M722 340h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="738" y="368">O</text>
    <path class="cell" d="M782 340h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="798" y="368">V</text>
    <path class="cell" d="M842 340h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
    <text class="letter" x="858" y="368">E</text>
    <path class="cell" d="M902 340h32a12 12 0 0 1 12 12v32a12 12 0 0 1-12 12h-32a12 12 0 0 1-12-12v-32a12 12 0 0 1 12-12Z"/>
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const algorithmXLetters = [...document.querySelectorAll("#algorithm-x .letter")];
  const allLetters = [...document.querySelectorAll(".algorithm-banner .letter")];

  // Fade all letters in with staggered timing
  let delay = 0;
  ...
  // After letters are done, highlight Algorithm X boxes one by one
  const highlightStart = delay + 400;
  algorithmXCells.forEach((cell, index) => {
    setTimeout(() => {
      cell.classList.add("algox-highlight");          // shade the cell
      algorithmXLetters[index].style.fill = "white"; // turn the letter white
    }, highlightStart + index * 200); // stagger left to right
  });
});
</script>
